...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/resources/account/static/h-ui.admin/skin/green/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/resources/account/static/h-ui.admin/css/style.css" />
<title>木婉清影视管理平台</title>
<meta name="keywords" content="木婉清影视管理平台">
<meta name="description" content="木婉清影视管理平台">
</head>
<body>
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">木婉清影视管理平台</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
			<span class="logo navbar-slogan f-l mr-10 hidden-xs"></span> 
			<a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			<nav class="nav navbar-nav">
				<ul class="cl">
					<li class="dropDown dropDown_hover">
					<li class="navbar-levelone current"><a href="javascript:;">影视网</a></li>
					<li class="navbar-levelone"><a href="javascript:;">小说网</a></li>
					<li class="navbar-levelone"><a href="javascript:;">图片网</a></li>
					<li class="navbar-levelone"><a href="javascript:;">音乐网</a></li>
				</li>
			</ul>
		</nav>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="${pageContext.request.contextPath }/account/toVideoListPage.do" data-title="视频管理" href="javascript:void(0)">视频管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-comments">
		...
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath }/account/toMemberList.html" data-title="会员列表" href="javascript:;">会员列表</a></li>
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					...
					<li><a data-href="${pageContext.request.contextPath }/system/toSystemData.do" data-title="数据字典" href="javascript:void(0)">数据字典</a></li>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="${pageContext.request.contextPath }/user/toWelcome.html">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="${pageContext.request.contextPath }/user/toWelcome.html"></iframe>
	</div>
</div>
</section>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/account/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
