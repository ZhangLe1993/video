			...
			<div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;"> 
				<div class="layui-tab-item layui-show"> 
					<div class="layui-btn-container" style="margin: 10px 0;"> 
						<a href="${pageContext.request.contextPath }/user/toUserForget.do" class="layui-btn layui-btn-sm layui-btn-primary">通过邮箱找回</a> 
						<a href="javascript:;" class="layui-btn layui-btn-sm">通过手机找回</a> 
					</div> 
						...
						<form method="post"> 
							...
							<div class="layui-form-item"> 
								...
								<div class="layui-form-mid"> 
									<span style="color: #c00;">贤心是男是女？</span> 
								</div> 
							</div> 
							<div class="layui-form-item"> 
